...
export CURRENT_PATH=/home/j.cooke/modules/matlab-R2023b
export CLUSTER_DIRECTORY=/shared/EL9/explorer
export SOFTWARE_NAME=matlab
export SOFTWARE_VERSION=R2023b

export GITHUB_URL=https://github.com/northeastern-rc-software-modules/matlab-R2023b
